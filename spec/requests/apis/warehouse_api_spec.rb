...
describe 'Warehouse API' do 
  ...
  context 'GET /api/v1/warehouses' do 
    it 'list all warehouses ordered by name' do 
      ...
      expect(json_response[1]['name']).to eq 'Armazém BA'
    end
  ...
  context 'POST /api/v1/warehouses' do 
    it 'success' do 
      warehouse_params = { warehouse: {name: 'Aeroporto SP', code: 'GRU', city: 'Guarulhos', area: '100000',
                                      address: 'Avenida do Aeroporto, 1000', zip_code: '15000-000',
                                      description: 'Galpão destinado para cargas internacionais' } }
      ...
      expect(json_response['zip_code']).to eq '15000-000'
